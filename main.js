...
var LLMService = class {
  ...
  async chat(messages, tools, options) {
    ...
    try {
      ...
      const message = (_d = (_c = data.choices) == null ? void 0 : _c[0]) == null ? void 0 : _d.message;
      const content = (_e = message == null ? void 0 : message.content) != null ? _e : "";
      const toolCalls = (_f = message == null ? void 0 : message.tool_calls) != null ? _f : [];
